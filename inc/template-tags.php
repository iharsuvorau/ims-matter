...
if ( ! function_exists( 'ims_matter_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function ims_matter_posted_on() {
...
if ( ! function_exists( 'ims_matter_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function ims_matter_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'ims-matter' ),
...
if ( ! function_exists( 'ims_matter_entry_footer' ) ) :
	/**
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'ims-matter' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'ims-matter' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'ims_matter_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function ims_matter_post_thumbnail() {
